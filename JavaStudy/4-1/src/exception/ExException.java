 ...
 public static void main(String[] args) {
	 ...
	 do {
		 ...
		 try {
			 ...
			 /*以下の例外を発生させるためのパラメーター（1〜3）のいずれかを入力してください。\n・1: NullPointerException\n・2: ArrayIndexOutOfBoundsException\n・3: ClassCastException*/
			 System.out.println(CONST_COMMON_TASK_INPUT_NAME);
			 parameter = sc.nextInt();

			 switch (parameter) {
			 case CONST_EXCEPTION_TRIGER_NULL: /*case 1*/
			 ...
			 case CONST_EXCEPTION_TRIGER_ARRAY_OUT_OF_BOUNDS:
				...
				nullStrings[1] = "one";
				nullStrings[2] = "two";
				System.out.println(nullStrings[5]);
				break;
 ...
 */
  // ここへ記述
 private static void nullpo(int t) throws NullPointerException {
	 switch (t) {
	 case 1:throw new NullPointerException(CONST_MSG_NULLPO);
	 }
 }
